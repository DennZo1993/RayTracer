...
TEST(SphereTests, IntersectionTest) {
  ...
  ASSERT_VEC_NEAR(glm::dvec3(5.0, 0.0, 0.0), res1.getNormalRay().origin, EPS_WEAK);
  ASSERT_VEC_NEAR(glm::dvec3(1.0, 0.0, 0.0), res1.getNormalRay().direction, EPS_WEAK);
  ...
  ASSERT_VEC_NEAR(glm::dvec3(0.0, 5.0, 0.0), res1.getNormalRay().origin, EPS_WEAK);
  ASSERT_VEC_NEAR(glm::dvec3(0.0, 1.0, 0.0), res1.getNormalRay().direction, EPS_WEAK);
